      ...
      <div className="flex items-center justify-between px-5 lg:px-20 h-[70px] border-b">
        <div className="flex items-center gap-9">
          <div className="flex items-center gap-2">
            ...
            <h1
              onClick={() => navigate("/")}
              className="logo cursor-pointer text-2xl md:text-2xl  text-[#3f1ef8]"
            >
              RentKaro
            </h1>
          </div>
            ...
            >
              {mainCategory.map((item) => (
                <li
                  ...
                  className="mainCategory hover:text-[#3f1ef8] cursor-pointer hover:border-b-2 h-[70px] px-4 border-[#3f1ef8  ] flex items-center"
                >
                  {item.name}
                </li>
              ))}
